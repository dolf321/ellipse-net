...
def intersection_area_parallelized(rect1, rect2):
    """Calculate the inter

    Args:
        rect1: vertices of the rectangles (Rects, 4, 2)
        rect2: vertices of the rectangles (Rects, 4, 2)
    ...
    # Loop over the edges of the second rectangle
    roll_rect2 = torch.roll(rect2, -1, dims=0) # Shape (Rects, 4, 2)
